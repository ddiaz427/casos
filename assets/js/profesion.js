$(function(){
    obj_funciones.getdatatable('table','profesion/mostrar');
...
function class_profesion(){

    this.nuevo = function(){
        var data = obj_funciones.getajaxsimple({
            url :  base_url+'profesion/nuevo',
            datatype: 'html',
        });
...
var obj_profesion = new class_profesion();
