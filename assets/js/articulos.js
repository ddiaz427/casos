$(function(){
    obj_funciones.getdatatable('table','articulos/mostrar');
...
function class_articulo(){

    this.nuevo = function(){
        var data = obj_funciones.getajaxsimple({
            url :  base_url+'articulos/nuevo',
            datatype: 'html',
        });
    ...
    this.submitForm = function() {
      ...
      this.procesos = function (id,selected_id){
        ...
        var data = obj_funciones.getajaxsimple({
            url : base_url + "articulos/get_procesos", 
            data : {caso_id: id}
        });
     ...
     this.subprocesos = function (id,selected_id){
        if(selected_id == undefined) selected_id = '';
        var data = obj_funciones.getajaxsimple({
            url : base_url + "articulos/get_subprocesos", 
            data : {proceso_id: id}
        });
        var html = '<option value="">..:: Seleccione ::..</option>';
        for(var index in data) { sel = "";
     ...
     this.actividad = function (id,selected_id){
        if(selected_id == undefined) selected_id = '';
        var data = obj_funciones.getajaxsimple({
            url : base_url + "articulos/get_actividades", 
            data : {proceso_id: id}
        });
        var html = '<option value="">..:: Seleccione ::..</option>';
        for(var index in data) { sel = "";
     ...
     this.actividaddetalle = function (id,selected_id){
        if(selected_id == undefined) selected_id = '';
        var data = obj_funciones.getajaxsimple({
            url : base_url + "articulos/get_detalle_actividades", 
       ...
       $("#detalleactividad").html(html);
    }
}
var obj_articulo = new class_articulo();
