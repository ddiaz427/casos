<?php echo form_open(base_url().'tipoidentificacion/nuevo', array('id' => 'identificacion', 'onsubmit' => 'obj_tiposidentificacion.submitForm(); return false;'), array('enviado' => 'enviado')); ?>
