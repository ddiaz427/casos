        ...
        <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr class="active">
                    ...
                    <th class="text-center">Nombre del Caso</th>
...
<script src="<?php echo base_url('assets/js/casos.js')?>"></script>
<script src="<?php echo base_url('assets/js/clientescasos.js')?>"></script>