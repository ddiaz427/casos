<?php echo form_open(base_url().'tipoprocesos/nuevo', array('id' => 'proceso', 'onsubmit' => 'obj_tiposprocesos.submitForm(); return false;'), array('enviado' => 'enviado')); ?>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Nuevo Tipo de Procesos</h4>
            </div>
